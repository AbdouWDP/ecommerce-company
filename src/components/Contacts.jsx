...
function Contacts() {
  return (
    <section className="w-screen h-screen bg-sec flex justify-center items-center text-white">
      <footer className="footer w-4/5 h-4/5 flex justify-between max-lg:flex-col max-lg:gap-12">
        ...
        <div className="w-1/2 flex flex-col gap-10 items-end max-lg:w-full">
          <div className="footer-image w-1/2 max-md:w-4/5 max-lg:w-3/5">
            <img
          ...
          <div className="w-full flex justify-between max-lg:flex-col max-lg:gap-8">
            <div className="w-1/2 max-lg:w-full flex flex-col items-end gap-4">
