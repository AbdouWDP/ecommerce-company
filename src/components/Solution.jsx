...
const ImgGallery = ({ src }) => {
  return (
    <div
      className="image overflow-hidden cursor-pointer"
      style={{ aspectRatio: 1 / 0.8, width: "45%" }}
    >
      <img
        src={src}
        alt=""
      ...
      <section className="solutions-section w-screen h-fit bg-sec flex justify-center items-center">
        <article className="w-4/5 py-4" style={{ height: "95%" }}>
          <div className="w-full">
            <div className="w-1/2 text-main text-5xl font-bold">
              <h1>IT Solution Strategy Development For Your Business</h1>
            </div>
            <div className="w-full my-20 flex gap-8">
              <div className="w-1/2  flex flex-col gap-12">
                <LeftSolution icon={<GiSmartphone />} />
                <LeftSolution icon={<PiGearLight />} />
              </div>
              <div className="w-1/2 flex flex-col gap-12 mt-28">
                <RightSolution icon={<PiGearLight />} />
                <RightSolution icon={<GiSmartphone />} />
              </div>
            </div>
          </div>
          <div className="images-gallery w-3/4 flex flex-wrap gap-4">
          ...
          <div className="w-3/4 text-white py-4">
            <p>
